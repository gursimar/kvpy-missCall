...
# copied and slightly modified from wx.py.shell.py
...
class ShellFrame(frame.Frame, frame.ShellFrameMixin):
    ...
    def __init__(self, parent=None, id=-1, title='',
        ...
        intro = 'push %s - The Flakiest Python Shell for S60' % '0.1'
...
Platform: %s""" % \
    ...
    def LoadSettings(self, config):
        ...
        if zoom != -99:
            self.SetZoom(zoom)
        self.sync_config_file = config.Read('Options/SyncConfigFile')
        print 'just loaded', self.sync_config_file
    ...
    def SaveSettings(self, config):
        ...
        config.Write( 'Options/SyncConfigFile', 'sync.config' )
        #print 'called savesettings'
